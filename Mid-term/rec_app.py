...
fig.update_layout(
    paper_bgcolor="#1e2130",  # Set the background color to light gray
    title_text='Top Genres'
)

fig2= px.line(books, y="books_count", x="average_rating")
fig2.update_layout(
    paper_bgcolor="#1e2130",  # Set the background color to light gray
    title_text='Book Count VS Average Rating'
)
def fig3(list_m):
...
def update_output(value):
	getl=models.recco.get_recommendations_new(value)
	return fig3(getl)
